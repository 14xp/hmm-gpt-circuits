...
options: dict[str, GPTTrainingConfig] = map_options(
    ...
    GPTTrainingConfig(
        ...
        gpt_config=gpt_options["spiral_12_64x1_untied"],
        data_dir="data/spiral/spiral_b_12_20250813_171258_json_output",
        eval_interval=50,
        eval_steps=20,
        batch_size=128,
        gradient_accumulation_steps=1,
    ...
    GPTTrainingConfig(
        ...
        gpt_config=gpt_options["spiral_12_64x4_untied"],
        data_dir="data/spiral/spiral_b_12_20250813_154510_json_output",
        eval_interval=50,
        eval_steps=20,
        batch_size=128,
        gradient_accumulation_steps=1,
